...
| [Specimen Making](docs/agents/specimen_agent.md) | Decides fabrication suitability and dispatches bounded tools on the manufacturing route | experiment specification → specimen evidence/handoff | physical possible after printer gates | [Reference](docs/agents/specimen_agent.md) | [Flow](docs/agents/assets/figures/specimen_01_closed_loop_handoffs.svg) · [Execution](docs/agents/assets/figures/specimen_02_execution_effect_boundary.svg) · [Connections](docs/agents/assets/figures/specimen_03_api_connection_architecture.svg) |
...
| [Knowledge](docs/agents/knowledge_agent.md) | Curates source-backed Markdown, preserves research memory, and supplies scoped context | accepted evidence / source inbox → cited knowledge / agent context | local Markdown/typed persistence; no physical action | [Reference](docs/agents/knowledge_agent.md) · [Source Library](docs/knowledge/manual_rag_knowledge.ko.md) | [Flow](docs/agents/assets/figures/knowledge_01_closed_loop_handoffs.svg) · [Execution](docs/agents/assets/figures/knowledge_02_execution_effect_boundary.svg) · [Connections](docs/agents/assets/figures/knowledge_03_api_connection_architecture.svg) |
