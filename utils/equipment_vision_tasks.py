...
_TASKS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "result_label": "DOWN",
        "description": "Compare initial and final marker spans over 10 seconds; a decrease of at least 0.25 px indicates DOWN.",
        "timeout_s": 10,
        "runtime_modes": ["test", "live"],
    ...
    },
    {
        ...
        "description": "Observe non-working marker geometry after return over 10 seconds; upward drift alone does not prove clearance.",
        "timeout_s": 10,
        "runtime_modes": ["test", "live"],
