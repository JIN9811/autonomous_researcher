...
def _skill_workflows(reference_root: Path) -> dict[str, list[dict[str, Any]]]:
    ...
    return {
        ...
        "save_raw_data": [
            ...
            _step(3, "Focus Save dialog directory", {"action": "hotkey", "keys": ["ctrl", "l"]}),
            _step(4, "Paste worker-owned Raw CSV directory", {"action": "paste_runtime_value", "key": "raw_csv_directory"}),
        ...
        "validate_raw_data": [
            _step(1, "Require the exact CSV produced by Save Raw Data", {"action": "wait_for_file", "pattern": "{raw_csv_path}", "timeout_s": 10, "poll_interval_s": 0.25, "stable_for_sec": 2.0, "required": True}),
