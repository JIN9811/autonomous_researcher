...
@pytest.mark.parametrize('module_id', ['design', 'orchestrator', 'specimen', 'vision'])
...
@pytest.mark.parametrize('module_id', ['design', 'orchestrator', 'specimen', 'vision', 'manipulation'])
