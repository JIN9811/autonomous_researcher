...
| Analysis | `graphs/modules/analysis` | [Analysis](agents/analysis_agent.md) | [기존 UTM guideline](agents/analysis_utm_runtime_guideline.txt) |
| Knowledge | `graphs/modules/knowledge` | [Knowledge](agents/knowledge_agent.md) | [Knowledge operations](knowledge/markdown_memory_operations.ko.md) |
...
- `docs/runtime/`: Runtime IDE, graph, loop, logging, test mode 설명
...
- Knowledge memory/evidence schema를 바꾸면 `agents/knowledge_agent.md`와 Knowledge 운영 문서를 같이 갱신합니다.
