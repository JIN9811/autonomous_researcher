...
- Before publishing a `.autoeject.*` artifact, the operator must confirm front path/door clearance, ramp/bin readiness, toolhead cover security, release surface/profile, and supervised first ejection.
