...
- Runtime cards should show final `cell_size_mm`, `wall_thickness_mm`, derived `relative_density`, and `expected_mass_g` from the selected candidate, not from an intermediate LLM suggestion.
