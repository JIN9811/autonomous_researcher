...
- `analysis_agent`: experimental-data analysis owner. It parses equipment CSV/JSON or inline measurements, computes curves and metrics, reviews evidence with the LLM, and evaluates the configured objective for BO. Missing real measurements block live analysis.
