...
**Spec:** `docs/superpowers/specs/2026-09-13-package-agent-bridge-modularization-design.md`; `docs/superpowers/specs/2026-09-13-executable-agent-ide-contract-design.md`.
