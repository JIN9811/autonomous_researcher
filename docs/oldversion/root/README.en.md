...
> Archived 2026-09-14. Previous duplicated operator overview; not the current implementation contract. See the [archive index](../README.md).
...
- [Documentation governance Design](../../../docs/oldversion/superpowers/specs/2026-08-08-documentation-governance-design.md)
...
- Current code and maintained References define the implemented system. Earlier instructions, design packages and development plans are preserved under `docs/oldversion/` as history.
