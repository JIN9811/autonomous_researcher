...
related_docs:
  ...
  - docs/oldversion/superpowers/specs/2026-08-09-agent-reference-documentation-design.md
supersedes: []
---
...
| Manipulation | verified specimen and Vision context become a bounded transfer and post-place handoff | task/profile/policy gates, rollout, observed task stage, Vision verification, decision, result, and evidence | LeRobot APIs, policy/session services, serial/camera/Isaac processes, robot, and stop/status proof |
