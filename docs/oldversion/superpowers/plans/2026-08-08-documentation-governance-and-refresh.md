...
**Interfaces:**
- Consumes: validator metadata rules from Task 1 and the approved Design at `docs/oldversion/superpowers/specs/2026-08-08-documentation-governance-design.md`.
