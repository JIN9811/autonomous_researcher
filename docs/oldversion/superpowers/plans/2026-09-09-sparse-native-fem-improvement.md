...
**Spec:** `docs/oldversion/superpowers/specs/2026-09-09-analysis-multifidelity-decision-design.md`; additional user requirement: modestly sparse mesh, actual completed new result, then commit/retag/push.
