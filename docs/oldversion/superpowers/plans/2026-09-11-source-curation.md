...
governing_design: docs/oldversion/superpowers/specs/2026-09-11-source-curation-design.md
related_docs:
...
**Spec:** `docs/oldversion/superpowers/specs/2026-09-11-source-curation-design.md`

## Global Constraints

- Work in `<home>/autonomous_researcher` on the existing feature branch; do not switch the running checkout or merge unrelated branches.
