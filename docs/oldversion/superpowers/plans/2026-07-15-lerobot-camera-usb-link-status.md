...
```bash
git diff -- device_bridges/lerobot_bridge.py web/static/lerobot.js web/static/styles.css tests/unit/test_lerobot_bridge.py tests/unit/test_lerobot_gui_static.py docs/oldversion/superpowers/plans/2026-07-15-lerobot-camera-usb-link-status.md
```
