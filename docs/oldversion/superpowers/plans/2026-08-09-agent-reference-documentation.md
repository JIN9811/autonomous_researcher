...
- Every agent Reference uses the exact H2 order defined in `docs/oldversion/superpowers/specs/2026-08-09-agent-reference-documentation-design.md`.
...
- [x] **Step 1: Reproduce the ten-agent inventory and route families**
...
- [x] **Step 2: Write the canonical agent index**
...
- [x] **Step 3: Write all five matrix views**
...
- [x] **Step 4: Validate the two documents directly**
...
- [x] **Step 5: Commit the shared documentation core**
...
- [x] **Step 1: Document Orchestrator**
...
- [x] **Step 3: Validate control-plane References and cross-links**
...
- [x] **Step 4: Commit control-plane References**
...
- [x] **Step 2: Document Specimen Making**
...
- [x] **Step 3: Validate Design/Specimen References**
...
- [x] **Step 4: Commit Design/Specimen References**
...
- [x] **Step 3: Validate Vision/Manipulation References**
...
- [x] **Step 4: Commit Vision/Manipulation References**
...
- [x] **Step 1: Document Lab Equipment**
...
- [x] **Step 3: Validate Equipment/Analysis References**
...
- [x] **Step 4: Commit Equipment/Analysis References**
...
- [x] **Step 3: Validate Knowledge/BO References**
...
- [x] **Step 4: Commit Knowledge/BO References**
...
- [x] **Step 1: Register the twelve new governed documents**
...
- [x] **Step 2: Update repository and paper navigation**
...
- [x] **Step 3: Run governed document and publication validation**
...
- [x] **Step 1: Audit the canonical inventory and section contract**
...
- [x] **Step 2: Audit manifest tool, step, and output coverage**
...
- [x] **Step 3: Audit API paths and effect classifications**
...
- [x] **Step 4: Run public-content and unresolved-marker scans**
...
- [x] **Step 5: Run final validation and inspect scope**
...
- [x] **Step 6: Commit audit corrections if tracked files changed**
