...
```bash
git diff -- web/static/planning.js tests/integration/test_live_gui_runtime_layout.py docs/oldversion/superpowers/specs/2026-08-08-lab-equipment-live-gui-operations-design.md docs/oldversion/superpowers/plans/2026-08-08-lab-equipment-live-gui-operations.md
git status --short
```
