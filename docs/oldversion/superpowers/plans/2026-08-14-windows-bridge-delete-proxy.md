...
- Use `docs/oldversion/superpowers/specs/2026-08-14-windows-bridge-delete-proxy-design.md` as the behavioral specification; no additional user-facing documentation is required.
...
git status --short -- \
  ...
  tests/unit/test_equipment_pyautogui_bridge.py \
  tests/integration/test_live_gui_runtime_layout.py \
  docs/oldversion/superpowers/specs/2026-08-14-windows-bridge-delete-proxy-design.md \
  docs/oldversion/superpowers/plans/2026-08-14-windows-bridge-delete-proxy.md
```
