...
**Files:**
- Create: `docs/oldversion/superpowers/specs/2026-07-02-isaac-lab-live-e2e-runner-design.md`
- Create: `docs/oldversion/superpowers/plans/2026-07-02-isaac-lab-live-e2e-runner.md`
...
```bash
<home>/miniconda3/envs/lerobot/bin/python -m pytest tests/unit/test_lerobot_isaac_lab_e2e_contract.py -q
