...
**Tech Stack:** Isaac Lab 3.0.0 beta checkout, Isaac Sim Python via `<home>/IsaacLab/isaaclab.sh -p`, Gymnasium task registry, local `integrations.isaac_lab_robotis_omx` callback.
...
**Files:**
- Inspect: `<home>/IsaacLab/scripts/imitation_learning/isaaclab_mimic/annotate_demos.py`
- Inspect: `<home>/IsaacLab/scripts/imitation_learning/isaaclab_mimic/generate_dataset.py`
- Inspect: `<home>/IsaacLab/scripts/tools/replay_demos.py`
- Inspect: `<home>/IsaacLab/source/isaaclab/isaaclab/envs/mimic_env_cfg.py`
- Inspect: `<home>/IsaacLab/source/isaaclab/isaaclab/envs/manager_based_rl_mimic_env.py`
...
**Files:**
- Runtime: `<home>/IsaacLab/isaaclab.sh`
- Import: `isaaclab`
...
```bash
<home>/IsaacLab/isaaclab.sh -p - <<'PY'
...
```text
isaaclab <home>/IsaacLab/source/isaaclab/isaaclab/__init__.py
isaaclab_mimic <home>/IsaacLab/source/isaaclab_mimic/isaaclab_mimic/__init__.py
```

Observed: both imports resolved to the expected `<home>/IsaacLab/source/...` paths.
...
```bash
PYTHONPATH=<home>/autonomous_researcher <home>/IsaacLab/isaaclab.sh -p - <<'PY'
...
**Files:**
- Update: `docs/oldversion/superpowers/specs/2026-07-06-official-isaac-lab-mimic-integration-design.md`
- Update: `docs/oldversion/superpowers/plans/2026-07-06-official-isaac-lab-mimic-phase1.md`
