...
- Modify: `docs/oldversion/superpowers/specs/2026-07-20-manipulation-live-runtime-grounded-cards-design.md` only if implementation details require clarification.
