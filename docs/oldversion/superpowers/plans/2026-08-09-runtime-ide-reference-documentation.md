...
```bash
git add scripts/validate_documentation.py tests/unit/test_documentation_validation.py docs/oldversion/superpowers/plans/2026-08-09-runtime-ide-reference-documentation.md
