...
- `device_bridges/lerobot_bridge.py`
  ...
  - Pi0.5 train/rollout은 `lerobot-pi05` conda env와 `HF_HOME=<home>/.cache/huggingface_pi05` 쪽으로 분리되어 있다.

- `configs/lerobot.yaml`
  - `pi05_conda_env_name: lerobot-pi05`
  - `pi05_repo_root: <home>/lerobot_pi05`
  - `pi05_hf_home: <home>/.cache/huggingface_pi05`
...
- `<home>/lerobot_pi05` + `lerobot-pi05` env에서 Pi0.5 inference 실행
