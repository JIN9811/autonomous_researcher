...
- `docs/oldversion/system/ATR_LangGraph_Runtime_IDE_Codex_Instructions.txt`
- `docs/oldversion/system/ATR_Self_Evolution_Codex_Instructions.txt`
- `docs/oldversion/ATR_Live_GUI_Graph_Package/docs/UI_SPEC.md`
- `docs/oldversion/ATR_Live_GUI_Graph_Package/docs/BACKEND_API_SPEC.md`
- `docs/oldversion/ATR_Live_GUI_Graph_Package/docs/GRAPH_INTEGRATION_SPEC.md`
- `docs/oldversion/ATR_Live_GUI_Graph_Package/docs/UX_SPEC.md`

### 1.3 이번에 만든 개선안

- `docs/oldversion/개선안/01_design_agent_agentic_loop_research.md`
- `docs/oldversion/개선안/02_specimen_making_agent_autonomous_fabrication_loop_research.md`
- `docs/oldversion/개선안/03_vision_agent_lab_perception_signal_loop_research.md`
- `docs/oldversion/개선안/04_manipulation_agent_pi05_vla_loop_research.md`
- `docs/oldversion/개선안/05_lab_equipment_agent_utm_visual_control_data_loop_research.md`
- `docs/oldversion/개선안/06_analysis_agent_data_pipeline_bo_handoff_research.md`
- `docs/oldversion/개선안/07_bo_agent_reasoning_augmented_optimizer_research.md`
- `docs/oldversion/개선안/08_knowledge_agent_self_evolution_memory_rag_research.md`
- `docs/oldversion/개선안/09_guardian_agent_graphwide_safety_incident_loop_research.md`
- `docs/oldversion/개선안/10_orchestration_agent_supervisor_followup_loop_research.md`
- `docs/oldversion/개선안/11_live_gui_control_surface_upgrade_plan.md`
- `docs/oldversion/개선안/12_free_modularization_gap_analysis.md`
- `docs/oldversion/개선안/13_bambulab_x2d_spc_device_bridge_research.md`
- `docs/oldversion/개선안/14_bambulab_gcode_autoejection_runtime_plan.md`
