...
- the actual browser screenshot is compared against `docs/oldversion/ATR_Live_GUI_Graph_Package/assets/reference/main_live_gui_reference.png` with pixel-level checks for mean RGB distance, bright-area ratio, and overall dark Runtime IDE visual direction
