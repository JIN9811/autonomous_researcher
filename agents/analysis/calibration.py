...
from agents.analysis.fem import _clip, _coordinates, _curve, _target, _verify_inputs
from agents.analysis.improvement import curve_error
...
async def calibrate(evidence, choose, call_tool, emit):
    ...
    from agents.analysis.mechanisms import assess_mechanisms, evidence_options
