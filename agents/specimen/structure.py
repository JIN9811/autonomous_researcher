...
def specimen_implementation_structure():
    return {"schema": "ax4lab.implementation_structure.v1", "operations": {
        "specimen.prepare": detail([
            ...
            ("geometry", "Geometry, mesh, manufacturing and handoff tools", "low", A, "SpecimenMakingAgent._prepare_fabrication"),
        ...
        "specimen.decide": detail([
            ...
            ("inspect", "Inspect evidence and return observations", "low", D, "decide_specimen"),
            ("execute", "experiment.evaluate / printer.prepare callback", "low", A, "SpecimenMakingAgent._decide_fabrication"),
            ...
            ("$operation", "choice", "validation", "bounded choice"),
            ("choice", "inspect", "call", "inspect"),
            ("inspect", "$operation", "evidence", "observation / next choice"),
        ...
        "specimen.finalize": detail([
            ...
            ("handoff", "Vision / manipulation fabricated packet", "high", A, "SpecimenMakingAgent._build_specimen_fabricated_packet"),
        ...
        "specimen.operator_input": detail([
            ("request", "Printer-path operator request", "high", A, "SpecimenMakingAgent._printer_path_choice_result"),
