...
class MemoryRecord(BaseModel):
    ...
    score: float | None = Field(..., description="Objective value; absent when not measured")
    uncertainty: float | None = Field(..., description="Validated uncertainty estimate; null when not estimated")
