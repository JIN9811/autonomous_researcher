"""Build read-only improvement evidence from typed Knowledge memory."""
...
def build_evidence_packs(
    *,
    ...
    """Create reviewable evidence packs for the top improvement targets."""
        ...
        packs.append(
            EvolutionEvidencePack(
                ...
                provenance=build_provenance_ref(
                    ...
                    associated_with=[target_id, "knowledge_agent", "improvement_evidence"],
                    derived_from=[run_id],
                    artifact_refs=evidence_refs,
                ),
                created_at=now,
...
def build_outcomes_for_active_variants(
    *,
    ...
    """Attribute historically active variants against the current run ledger.
