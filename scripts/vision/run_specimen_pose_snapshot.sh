...
color_topic = str(payload.get("color_topic") or os.environ.get("ATR_SPECIMEN_POSE_COLOR_TOPIC") or "/camera/color/image_raw")
depth_topic = str(payload.get("depth_topic") or os.environ.get("ATR_SPECIMEN_POSE_DEPTH_TOPIC") or "/camera/aligned_depth_to_color/image_raw")
info_topic = str(payload.get("info_topic") or os.environ.get("ATR_SPECIMEN_POSE_INFO_TOPIC") or "/camera/color/camera_info")
