...
if __name__ == '__main__':
    ...
    parser.add_argument('modules', nargs='*', choices=['design', 'orchestrator', 'specimen', 'vision', 'manipulation', 'equipment', 'analysis', 'bo'])
    args = parser.parse_args()
    root = Path(__file__).resolve().parents[1]
    for module_id in args.modules or ('design', 'orchestrator', 'specimen', 'vision', 'manipulation', 'equipment', 'analysis', 'bo'):
