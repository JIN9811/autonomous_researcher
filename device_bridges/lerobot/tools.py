...
def register_lerobot_tools(
    ...
    *,
    ...
    registry.register("lerobot.replay.start", lambda payload: bridge.replay_start(dict(payload or {})), device="robot:lerobot")
    registry.register("lerobot.replay.status", lambda payload: bridge.replay_status(dict(payload or {})))
    registry.register("lerobot.replay.stop", lambda payload: bridge.replay_stop(dict(payload or {})))
