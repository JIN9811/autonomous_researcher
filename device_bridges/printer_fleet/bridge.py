"""
File purpose:
- Shared printer fleet runtime and Bambu transport implementation for printer.prepare.
...
from device_bridges.printer_fleet.providers.bambu_autoejection import BambuGcodeAutoejectionPatcher, extract_object_bounds_mm
