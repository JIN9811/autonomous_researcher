...
class SpecimenPoseTrackerConfig:
    ...
    rsusb_pythonpath: str = str(DEFAULT_RSUSB_RUNTIME)
    rsusb_library_path: str = str(DEFAULT_RSUSB_RUNTIME)
    ...
    def from_devices_config(cls, devices_config: dict[str, Any], *, repo_root: Path) -> "SpecimenPoseTrackerConfig":
        ...
        return cls(
            ...
            rsusb_pythonpath=str(raw.get("rsusb_pythonpath") or DEFAULT_RSUSB_RUNTIME),
            rsusb_library_path=str(raw.get("rsusb_library_path") or DEFAULT_RSUSB_RUNTIME),
